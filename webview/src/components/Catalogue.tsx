...
export default () => (
    <>
        ...
        <MessageBar className="message-bar" messageBarType={MessageBarType.info}>
            <Link href="/basic">Packages, variables, and functions.</Link>
            <p>Learn the basic components of any Go program.</p>
        </MessageBar>
        <MessageBar className="message-bar" messageBarType={MessageBarType.info}>
            <Link href="/flowcontrol">Flow control statements: for, if, else, switch and defer</Link>
            <p>Learn how to control the flow of your code with conditionals, loops, switches and defers.</p>
        </MessageBar>
        <MessageBar className="message-bar" messageBarType={MessageBarType.info}>
            <Link href="/motetypes">More types: structs, slices, and maps.</Link>
        ...
        <MessageBar messageBarType={MessageBarType.info}>
            <Link href="/methods">Methods and interfaces</Link>
